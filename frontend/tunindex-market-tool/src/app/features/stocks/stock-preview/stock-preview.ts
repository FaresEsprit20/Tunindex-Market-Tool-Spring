...
import { MarketOverview } from '../../../shared/components/market-pulse/market-pulse';
...
@Component({
  ...
  imports: [DecimalPipe, RouterLink, CandlestickChart, ScorePanel, SkeletonBlock, MarketOverview, TabbedPanel, Tab, NewsList, RiskPanel],
